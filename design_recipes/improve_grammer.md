...
_So that I can improve my grammar
...
```ruby
# EXAMPLE
grammar_corrected = improve_grammar(text)
Return value is a capitalised letter sentence with a suitable ending punctuation.
Side effects? TBC? Loops?
...
improve_grammar("hi how are you") => ["Hi how are you."]
improve_grammar("hi how are you.") => ["Hi how are you."]
improve_grammar("") => [""]
improve_grammar("i had some breakfast") => ["I had some breakfast."]
